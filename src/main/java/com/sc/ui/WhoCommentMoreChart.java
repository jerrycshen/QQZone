...
public class WhoCommentMoreChart {

	public WhoCommentMoreChart(ViewChartService chartService) {
		initCommentMoreChart(chartService);
	}

	private void initCommentMoreChart(ViewChartService chartService) {

		Map<String, Integer> map = chartService.viewWhoCommentMore();
